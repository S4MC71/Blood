    ...
    <header className="sticky top-0 z-50 w-full border-b border-red-100/60 bg-white/90 backdrop-blur-xl dark:border-zinc-800/60 dark:bg-zinc-950/90">
      <div className="mx-auto flex max-w-6xl h-14 items-center justify-between px-4">
        ...
        <nav className="hidden md:flex items-center gap-1">
          <Link
            href="/"
            className="rounded-lg px-3 py-2 text-sm font-semibold text-zinc-600 hover:bg-zinc-100 hover:text-zinc-900 dark:text-zinc-300 dark:hover:bg-zinc-800 dark:hover:text-white transition-all"
          >
            Find Donor
          </Link>
          ...
          {email ? (
            ...
            <div className="flex items-center gap-2 ml-2">
              <Link
                href="/login"
                className="rounded-lg px-3 py-2 text-sm font-semibold text-zinc-600 hover:bg-zinc-100 dark:text-zinc-300 dark:hover:bg-zinc-800 transition-all"
              >
                Login
              </Link>
              <Link
                href="/register"
                className="inline-flex items-center justify-center rounded-lg bg-red-600 px-4 py-2 text-sm font-bold text-white hover:bg-red-700 transition-all shadow-md shadow-red-500/20"
              >
                Join as Donor
              </Link>
            </div>
